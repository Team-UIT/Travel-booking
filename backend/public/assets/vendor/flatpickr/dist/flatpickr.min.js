/* flatpickr v4.5.1,, @license MIT */ ! function(e, t) {
    ...
    function r(u, f) {
                ...
                void 0 !== e && "blur" !== e.type && function(e) {
                    ...
                    if (void 0 !== n.value && 2 === n.value.length) {
                        var d = n === h.hourElement,
                            s = n === h.minuteElement;
                        c < a ? (c = i + c + X(!d) + (X(d) && X(!h.amPM)), s && v(void 0, -1, h.hourElement)) : i < c && (c = n === h.hourElement ? c - i - X(!h.amPM) : a, s && v(void 0, 1, h.hourElement)), h.amPM && d && (1 === o ? c + r === 23 : Math.abs(c - r) > o) && (h.amPM.textContent = h.l10n.amPM[X(h.amPM.textContent === h.l10n.amPM[0])]), n.value = Q(c)
                    }
                }(e);
                var t = h._input.value;
                p(), V(), h._input.value !== t && h._debouncedChange()
            }
        }
        ...
        function p() {
            if (void 0 !== h.hourElement && void 0 !== h.minuteElement) {
                ...
                void 0 !== h.amPM && (e = n, t = h.amPM.textContent, n = e % 12 + 12 * X(t === h.l10n.amPM[1]));
        ...
        function c(e, t, n) {
            void 0 !== h.latestSelectedDateObj && h.latestSelectedDateObj.setHours(e % 24, t, n || 0, 0), h.hourElement && h.minuteElement && !h.isMobile && (h.hourElement.value = Q(h.config.time_24hr ? e : (12 + e) % 12 + 12 * X(e % 12 == 0)), h.minuteElement.value = Q(t), void 0 !== h.amPM && (h.amPM.textContent = h.l10n.amPM[X(12 <= e)]), void 0 !== h.secondElement && (h.secondElement.value = Q(n)))
        }
        ...
        function D(e, t, n, a) {
            var i, o = N(t, !0),
                r = ue("span", "flatpickr-day " + e, t.getDate().toString());
            ...
            function(e, t) {
                for (var n = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : h.currentMonth, a = 0 < t ? h.config.showMonths : -1, i = 0 < t ? 1 : -1, o = n - h.currentMonth; o != a; o += i)
                    for (var r = h.daysContainer.children[o], l = n - h.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0, c = r.children.length, d = l; 0 <= d && d < c && d != (0 < t ? c : -1); d += i) {
                        var s = r.children[d];
                        if (-1 === s.className.indexOf("hidden") && N(s.dateObj) && Math.abs(e.$i - d) >= Math.abs(t)) return w(s)
                    }
                h.changeMonth(i), C(b(i), 0)
            }(a, t): w(a)
        }
        ...
        function y() {
            if (void 0 !== h.daysContainer) {
                fe(h.daysContainer), h.weekNumbers && fe(h.weekNumbers);
                for (var e = document.createDocumentFragment(), t = 0; t < h.config.showMonths; t++) {
                    var n = new Date(h.currentYear, h.currentMonth, 1);
                    n.setMonth(h.currentMonth + t), e.appendChild(M(n.getFullYear(), n.getMonth()))
                }
        ...
        function E() {
            fe(h.monthNav), h.monthNav.appendChild(h.prevMonthNav);
        ...
        function I(e, t) {
            ...
            n < 0 && !0 === h._hidePrevMonthArrow || 0 < n && !0 === h._hideNextMonthArrow || (h.currentMonth += n, (h.currentMonth < 0 || 11 < h.currentMonth) && (h.currentYear += 11 < h.currentMonth ? 1 : -1, h.currentMonth = (h.currentMonth + 12) % 12, q("onYearChange")), y(), q("onMonthChange"), G())
        }
        ...
        function N(e, t) {
            ...
            if (h.config.minDate && n && le(n, h.config.minDate, void 0 !== t ? t : !h.minDateHasTime) < 0 || h.config.maxDate && n && 0 < le(n, h.config.maxDate, void 0 !== t ? t : !h.maxDateHasTime)) return !1;
        ...
        function A(e) {
                ...
                switch (e.keyCode) {
                    ...
                    case 39:
                        if (o) h.hourElement && h.hourElement.focus();
                            ...
                            e.ctrlKey ? (I(r), C(b(1), 0)) : C(void 0, r)
                        }
                        break;
                    case 38:
                    case 40:
                        ...
                        h.daysContainer ? e.ctrlKey ? (_(h.currentYear - l), C(b(1), 0)) : o || C(void 0, 7 * l) : h.config.enableTime && (!o && h.hourElement && h.hourElement.focus(), g(e), h._debouncedChange());
                        break;
                    case 9:
                        if (!o) break;
                        ...
                        if (-1 !== d) {
                            ...
                            void 0 !== s && (e.preventDefault(), s.focus())
                        }
                }
            }
            if (void 0 !== h.amPM && e.target === h.amPM) switch (e.key) {
                ...
                case h.l10n.amPM[0].charAt(0).toLowerCase():
                    h.amPM.textContent = h.l10n.amPM[0], p(), V();
                    break;
                case h.l10n.amPM[1].charAt(0):
                case h.l10n.amPM[1].charAt(0).toLowerCase():
                    h.amPM.textContent = h.l10n.amPM[1], p(), V()
            }
            q("onKeyDown", e)
        }
                ...
                for (var u = 0; u < h.config.showMonths; u++)
                    for (var f = h.daysContainer.children[u], m = h.daysContainer.children[u - 1], i = function(e, t) {
                            ...
                            return i ? (n.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach(function(e) {
                                ...
                                n.classList.remove(e)
                            }), void(void 0 !== o && (o.classList.add(r < h.selectedDates[0].getTime() ? "startRange" : "endRange"), !f.contains(o) && 0 < u && m && m.lastChild.dateObj.getTime() >= a || (l < r && a === l ? n.classList.add("startRange") : r < l && a === l && n.classList.add("endRange"), d <= a && (0 === s || a <= s) && ce(a, l, r) && n.classList.add("inRange")))))
        ...
        function Y(a) {
            return function(e) {
                ...
                void 0 !== t && (h["min" === a ? "minDateHasTime" : "maxDateHasTime"] = 0 < t.getHours() || 0 < t.getMinutes() || 0 < t.getSeconds()), h.selectedDates && (h.selectedDates = h.selectedDates.filter(function(e) {
                    return N(e)
                }), h.selectedDates.length || "min" !== a || i(t), V()), h.daysContainer && (W(), void 0 !== t ? h.currentYearElement[a] = t.getFullYear().toString() : h.currentYearElement.removeAttribute(a), h.currentYearElement.disabled = !!n && void 0 !== t && n.getFullYear() === t.getFullYear())
            }
        }

        function H() {
            "object" != typeof h.config.locale && void 0 === pe.l10ns[h.config.locale] && h.config.errorHandler(new Error("flatpickr: invalid locale " + h.config.locale)), h.l10n = Object.assign({}, pe.l10ns.default, "object" == typeof h.config.locale ? h.config.locale : "default" !== h.config.locale ? pe.l10ns[h.config.locale] : void 0), ae.K = "(" + h.l10n.amPM[0] + "|" + h.l10n.amPM[1] + "|" + h.l10n.amPM[0].toLowerCase() + "|" + h.l10n.amPM[1].toLowerCase() + ")", h.formatDate = oe(h), h.parseDate = re({
                config: h.config,
                l10n: h.l10n
            })
        }
        ...
        function L(e) {
            if (void 0 !== h.calendarContainer) {
                ...
                if (se(h.calendarContainer, "arrowTop", !d), se(h.calendarContainer, "arrowBottom", d), !h.config.inline) {
                    ...
                    se(h.calendarContainer, "rightMost", m), h.config.static || (h.calendarContainer.style.top = s + "px", m ? (h.calendarContainer.style.left = "auto", h.calendarContainer.style.right = f + "px") : (h.calendarContainer.style.left = u + "px", h.calendarContainer.style.right = "auto"))
                }
            }
        }

        function W() {
            h.config.noCalendar || h.isMobile || (G(), y())
        }
        ...
        function K(e) {
            ...
            if (void 0 !== t) {
                ...
                } else "range" === h.config.mode && (2 === h.selectedDates.length && h.clear(!1), h.selectedDates.push(a), 0 !== le(a, h.selectedDates[0], !0) && h.selectedDates.sort(function(e, t) {
                ...
                if (G(), y(), V(), h.config.enableTime && setTimeout(function() {
                        return h.showTimeInput = !0
                    }, 50), i || "range" === h.config.mode || 1 !== h.config.showMonths ? h.selectedDateElem && h.selectedDateElem.focus() : w(n), void 0 !== h.hourElement && setTimeout(function() {
        ...
        h.parseDate = re({
            ...
            q("onClose")
        }, h._createElement = ue, h.destroy = function() {
            ...
            if (!0 === h.isMobile) return e && (e.preventDefault(), e.target && e.target.blur()), setTimeout(function() {
            ...
            !0 === h.config.enableTime && !0 === h.config.noCalendar && (0 === h.selectedDates.length && (h.setDate(void 0 !== h.config.minDate ? new Date(h.config.minDate.getTime()) : new Date, !1), a(), V()), !1 !== h.config.allowInput || void 0 !== e && h.timeContainer.contains(e.relatedTarget) || setTimeout(function() {
                return h.hourElement.select()
            }, 50))
        }, h.redraw = W, h.set = function(e, t) {
            null !== e && "object" == typeof e ? Object.assign(h.config, e) : (h.config[e] = t, void 0 !== J[e] && J[e].forEach(function(e) {
                return e()
            }));
            h.redraw(), l()
            ...
            B(e, n), h.showTimeInput = 0 < h.selectedDates.length, h.latestSelectedDateObj = h.selectedDates[0], h.redraw(), l(), i(), V(t), t && q("onChange")
        }, h.toggle = function(e) {
        ...
        function z(e) {
            for (var t = 0; t < h.selectedDates.length; t++)
                if (0 === le(h.selectedDates[t], e)) return "" + t;
            return !1
        }
        ...
        function G() {
            h.config.noCalendar || h.isMobile || !h.monthNav || (h.yearElements.forEach(function(e, t) {
                var n = new Date(h.currentYear, h.currentMonth, 1);
                n.setMonth(h.currentMonth + t), h.monthElements[t].textContent = ne(n.getMonth(), h.config.shorthandCurrentMonth, h.l10n) + " ", e.value = n.getFullYear().toString()
        ...
        return function() {
            h.element = h.input = u, h.isOpen = !1,
                function() {
                    var e = ["wrap", "weekNumbers", "allowInput", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"],
                        ...
                        a = {};
                    h.config.parseDate = n.parseDate, h.config.formatDate = n.formatDate, Object.defineProperty(h.config, "enable", {
                        get: function() {
                    ...
                    var i = "time" === n.mode;
                    n.dateFormat || !n.enableTime && !i || (a.dateFormat = n.noCalendar || i ? "H:i" + (n.enableSeconds ? ":S" : "") : pe.defaultConfig.dateFormat + " H:i" + (n.enableSeconds ? ":S" : "")), n.altInput && (n.enableTime || i) && !n.altFormat && (a.altFormat = n.noCalendar || i ? "h:i" + (n.enableSeconds ? ":S K" : " K") : pe.defaultConfig.altFormat + " h:i" + (n.enableSeconds ? ":S" : "") + " K"), Object.defineProperty(h.config, "minDate", {
                        get: function() {
                    ...
                    Object.defineProperty(h.config, "minTime", {
                        ...
                        set: o("max")
                    }), "time" === n.mode && (h.config.noCalendar = !0, h.config.enableTime = !0), Object.assign(h.config, a, n);
                    for (var r = 0; r < e.length; r++) h.config[e[r]] = !0 === h.config[e[r]] || "true" === h.config[e[r]];
                    for (var l = t.length; l--;) void 0 !== h.config[t[l]] && (h.config[t[l]] = te(h.config[t[l]] || []).map(m));
                    ...
                    for (var c = 0; c < h.config.plugins.length; c++) {
                        ...
                        for (var s in d) ~t.indexOf(s) ? h.config[s] = te(d[s]).map(m).concat(h.config[s]) : void 0 === n[s] && (h.config[s] = d[s])
                    }
                    q("onParseConfig")
                }(), H(),
                function() {
                    if (h.input = h.config.wrap ? u.querySelector("[data-input]") : u, !h.input) return h.config.errorHandler(new Error("Invalid input element specified"));
                    h.input._type = h.input.type, h.input.type = "text", h.input.classList.add("flatpickr-input"), h._input = h.input, h.config.altInput && (h.altInput = ue(h.input.nodeName, h.input.className + " " + h.config.altInputClass), h._input = h.altInput, h.altInput.placeholder = h.input.placeholder, h.altInput.disabled = h.input.disabled, h.altInput.required = h.input.required, h.altInput.tabIndex = h.input.tabIndex, h.altInput.type = "text", h.input.setAttribute("type", "hidden"), !h.config.static && h.input.parentNode && h.input.parentNode.insertBefore(h.altInput, h.input.nextSibling)), h.config.allowInput || h._input.setAttribute("readonly", "readonly"), h._positionElement = h.config.positionElement || h._input
                }(),
                function() {
                    ...
                    h.currentYear = t.getFullYear(), h.currentMonth = t.getMonth(), 0 < h.selectedDates.length && (h.latestSelectedDateObj = h.selectedDates[0]), void 0 !== h.config.minTime && (h.config.minTime = h.parseDate(h.config.minTime, "H:i")), void 0 !== h.config.maxTime && (h.config.maxTime = h.parseDate(h.config.maxTime, "H:i")), h.minDateHasTime = !!h.config.minDate && (0 < h.config.minDate.getHours() || 0 < h.config.minDate.getMinutes() || 0 < h.config.minDate.getSeconds()), h.maxDateHasTime = !!h.config.maxDate && (0 < h.config.maxDate.getHours() || 0 < h.config.maxDate.getMinutes() || 0 < h.config.maxDate.getSeconds()), Object.defineProperty(h, "showTimeInput", {
                        ...
                        set: function(e) {
                            h._showTimeInput = e, h.calendarContainer && se(h.calendarContainer, "showTimeInput", e), h.isOpen && L()
                        }
                    })
                }(), h.utils = {
                    ...
                    if (h.calendarContainer = ue("div", "flatpickr-calendar"), h.calendarContainer.tabIndex = -1, !h.config.noCalendar) {
                        if (e.appendChild((h.monthNav = ue("div", "flatpickr-months"), h.yearElements = [], h.monthElements = [], h.prevMonthNav = ue("span", "flatpickr-prev-month"), h.prevMonthNav.innerHTML = h.config.prevArrow, h.nextMonthNav = ue("span", "flatpickr-next-month"), h.nextMonthNav.innerHTML = h.config.nextArrow, E(), Object.defineProperty(h, "_hidePrevMonthArrow", {
                                get: function() {
                                    return h.__hidePrevMonthArrow
                                },
                                set: function(e) {
                                    h.__hidePrevMonthArrow !== e && (se(h.prevMonthNav, "disabled", e), h.__hidePrevMonthArrow = e)
                                }
                                ...
                                set: function(e) {
                                    h.__hideNextMonthArrow !== e && (se(h.nextMonthNav, "disabled", e), h.__hideNextMonthArrow = e)
                                }
                            }), h.currentYearElement = h.yearElements[0], G(), h.monthNav)), h.innerContainer = ue("div", "flatpickr-innerContainer"), h.config.weekNumbers) {
                            var t = function() {
                        ...
                        h.rContainer = ue("div", "flatpickr-rContainer"), h.rContainer.appendChild(T()), h.daysContainer || (h.daysContainer = ue("div", "flatpickr-days"), h.daysContainer.tabIndex = -1), y(), h.rContainer.appendChild(h.daysContainer), h.innerContainer.appendChild(h.rContainer), e.appendChild(h.innerContainer)
                    }
                    h.config.enableTime && e.appendChild(function() {
                        h.calendarContainer.classList.add("hasTime"), h.config.noCalendar && h.calendarContainer.classList.add("noCalendar"), h.timeContainer = ue("div", "flatpickr-time"), h.timeContainer.tabIndex = -1;
                        var e = ue("span", "flatpickr-time-separator", ":"),
                            t = me("flatpickr-hour");
                        h.hourElement = t.childNodes[0];
                        var n = me("flatpickr-minute");
                        if (h.minuteElement = n.childNodes[0], h.hourElement.tabIndex = h.minuteElement.tabIndex = -1, h.hourElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getHours() : h.config.time_24hr ? h.config.defaultHour : function(e) {
                                switch (e % 24) {
                                    case 0:
                                    case 12:
                                        return 12;
                            ...
                            }(h.config.defaultHour)), h.minuteElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getMinutes() : h.config.defaultMinute), h.hourElement.setAttribute("data-step", h.config.hourIncrement.toString()), h.minuteElement.setAttribute("data-step", h.config.minuteIncrement.toString()), h.hourElement.setAttribute("data-min", h.config.time_24hr ? "0" : "1"), h.hourElement.setAttribute("data-max", h.config.time_24hr ? "23" : "12"), h.minuteElement.setAttribute("data-min", "0"), h.minuteElement.setAttribute("data-max", "59"), h.timeContainer.appendChild(t), h.timeContainer.appendChild(e), h.timeContainer.appendChild(n), h.config.time_24hr && h.timeContainer.classList.add("time24hr"), h.config.enableSeconds) {
                            h.timeContainer.classList.add("hasSeconds");
                            var a = me("flatpickr-second");
                            h.secondElement = a.childNodes[0], h.secondElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getSeconds() : h.config.defaultSeconds), h.secondElement.setAttribute("data-step", h.minuteElement.getAttribute("data-step")), h.secondElement.setAttribute("data-min", h.minuteElement.getAttribute("data-min")), h.secondElement.setAttribute("data-max", h.minuteElement.getAttribute("data-max")), h.timeContainer.appendChild(ue("span", "flatpickr-time-separator", ":")), h.timeContainer.appendChild(a)
                        }
                        return h.config.time_24hr || (h.amPM = ue("span", "flatpickr-am-pm", h.l10n.amPM[X(11 < (h.latestSelectedDateObj ? h.hourElement.value : h.config.defaultHour))]), h.amPM.title = h.l10n.toggleTitle, h.amPM.tabIndex = -1, h.timeContainer.appendChild(h.amPM)), h.timeContainer
                    }()), se(h.calendarContainer, "rangeMode", "range" === h.config.mode), se(h.calendarContainer, "animate", !0 === h.config.animate), se(h.calendarContainer, "multiMonth", 1 < h.config.showMonths), h.calendarContainer.appendChild(e);
                ...
                function() {
                    ...
                    var e = ee(j, 50);
                    h._debouncedChange = ee(d, ge), h.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && o(h.daysContainer, "mouseover", function(e) {
                        ...
                        capture: !0
                    }), !0 === h.config.clickOpens && (o(h._input, "focus", h.open), o(h._input, "mousedown", r(h.open))), void 0 !== h.daysContainer && (o(h.monthNav, "mousedown", r(Z)), o(h.monthNav, ["keyup", "increment"], n), o(h.daysContainer, "mousedown", r(K))), void 0 !== h.timeContainer && void 0 !== h.minuteElement && void 0 !== h.hourElement && (o(h.timeContainer, ["increment"], g), o(h.timeContainer, "blur", g, {
                        capture: !0
                    }), o(h.timeContainer, "mousedown", r(s)), o([h.hourElement, h.minuteElement], ["focus", "click"], function(e) {
                ...
                }(), (h.selectedDates.length || h.config.noCalendar) && (h.config.enableTime && i(h.config.noCalendar ? h.latestSelectedDateObj || h.config.minDate : void 0), V(!1)), t(), h.showTimeInput = 0 < h.selectedDates.length || h.config.noCalendar;
    ...
    return pe.defaultConfig = C, pe.l10ns = {
        en: Object.assign({}, ie),
    ...
    }, pe.parseDate = re({}), pe.formatDate = oe({}), pe.compareDates = le, "undefined" != typeof jQuery && (jQuery.fn.flatpickr = function(e) {
        return n(this, e)
